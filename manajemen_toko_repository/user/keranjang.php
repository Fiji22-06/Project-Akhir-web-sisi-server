    ...
    <div class="container">
        <?php if (!$cart['items']): ?>
            <div class="empty-state">
                ...
                <a href="<?= BASE_URL; ?>user/produk.php" class="btn btn-primary">Lihat Produk</a>
            </div>
        <?php else: ?>
            <div class="cart-layout">
                            ...
                            <tbody>
                                <?php foreach ($cart['items'] as $item): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?= BASE_URL; ?>user/update_keranjang.php" method="post" class="qty-form">
                                        ...
                                        <td class="text-end">
                                            <a href="<?= BASE_URL; ?>user/hapus_keranjang.php?id=<?= $produk['id']; ?>" class="btn btn-danger btn-sm btn-delete" data-confirm="Hapus produk dari keranjang?">
                ...
                <aside class="checkout-summary">
                    ...
                    <a href="<?= BASE_URL; ?>user/checkout.php" class="btn btn-success w-100">
                        <i class="bi bi-bag-check me-1"></i> Lanjut Checkout
                    </a>
                    <a href="<?= BASE_URL; ?>user/produk.php" class="btn btn-light w-100 mt-2">Tambah Produk</a>
                </aside>
            </div>
        <?php endif; ?>
    </div>
