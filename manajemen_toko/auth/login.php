...
<head>
    ...
    <title>Login | Manajemen Toko</title>
...
<body class="login-page">
    <main class="login-shell">
        <section class="login-panel">
            ...
            <h1>Sistem Manajemen Data Produk Toko</h1>
            ...
            <form action="<?= BASE_URL; ?>auth/proses_login.php" method="post" class="login-form">
                <div class="mb-3">
                ...
                <a href="<?= BASE_URL; ?>user/" class="btn btn-outline-secondary w-100 mt-2">
